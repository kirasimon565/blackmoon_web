  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          padding: EdgeInsets.only(right: screenWidth * 0.45), // Keep content constrained to left side
          child: Column(
            ...
            children: [
              Text(
                ...
                style: AppTextStyles.h1.copyWith(
                  fontSize: screenWidth * 0.06 > 36.0 ? 36.0 : (screenWidth * 0.06 < 20.0 ? 20.0 : screenWidth * 0.06),
